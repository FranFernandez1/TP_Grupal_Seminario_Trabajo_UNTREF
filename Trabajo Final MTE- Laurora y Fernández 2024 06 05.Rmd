...
Cuadro_1.1a <- base %>% 
  summarise(Poblacion         = sum(V1028),
            ...
            'Tasa Subocupación'               = percent(Subocupados/PEA, accuracy = 0.1))                       #'Tasa Subocupación demandante'    = percent(Suboc_demandante/PEA,
            #'Tasa Subocupación no demandante' = percent(Suboc_no_demand/PEA
