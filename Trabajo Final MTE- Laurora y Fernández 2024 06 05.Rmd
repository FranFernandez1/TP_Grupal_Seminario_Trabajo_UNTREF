...
Cuadro_1.1a <- base %>% 
  summarise(Poblacion         = sum(V1028),
            ...
            #Suboc_demandante  = sum(V1028[(VD4004 =="Pessoas subocupadas"|VD4004=="Pessoas subocupadas") & (V4071=="Sim"|VD4005)],na.rm=TRUE),#VD4005
            #Suboc_no_demand   = sum(V1028[(VD4004 =="Pessoas subocupadas"|VD4004=="Pessoas subocupadas") & V4071=="Não"],na.rm=TRUE),
            Subocupados       =  sum(V1028[(VD4004 =="Pessoas subocupadas"|VD4004=="Pessoas subocupadas")],na.rm=TRUE),
