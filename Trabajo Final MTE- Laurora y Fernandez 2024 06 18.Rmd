...
kable(FormalidadxSexo, format = "html", table.attr = "class='table table-striped'", caption = "Informalidad del Mercado de Trabajo de Brasil según sexo - 2019, 3er trimestre. Fuente: PNAD continua") %>%
  kable_styling(full_width = F, position = "center")
```
...
ggplot(FormalidadxSexo, aes(fill=Formalidad, y=n, x=V2007)) + 
    geom_bar(position="fill", stat="identity") + 
    scale_fill_viridis(discrete = T, option = "D")+
  labs(title = "Formalidad laboral por sexo. Población asalariada de 14 años y más. Brasil, 2019",
       x="Sexo",
       y="Proporción")+ theme_minimal()
