...
Variables <- c("WSTATOR", "MAINSTAT", "COEFF", "STAPRO","SIZEFIRM","TEMP","HWOVERPU","SEEKWORK","AVAILBLE")
...
kable(Cuadro_2_ESPAÑA, format = "html", table.attr = "class='table table-striped'", caption = "Tasas Básicas del Mercado de Trabajo de España - 2018. Fuente: EU LFS 2018-1") %>%
...
#Visualizamos los indicadores básicos de España
kable(Cuadro_2_UK, format = "html", table.attr = "class='table table-striped'", caption = "Tasas Básicas del Mercado de Trabajo de Reino Unido - 2018. Fuente: EU LFS 2018-1") %>%
  kable_styling(full_width = F, position = "center")
